...
from portfolio_web.components.styles import TextColor, Font, Size, Color
    ...
    return rx.box(
        rx.vstack(
            ...
            rx.hstack(
                ...
                rx.hstack(
                    social_link("github", Links.GITHUB_URL),
                    social_link("linkedin", Links.LINKEDIN_URL),
                    social_link("twitter", Links.TWITTER_URL),
                    social_link("facebook", Links.FACEBOOK_URL),
